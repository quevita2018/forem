...
describe Forem::PostsController do
  ...
  context 'not signed in' do
    ...
    it 'cannot delete posts' do
      delete :destroy, params: { forum_id: forum.to_param, topic_id: topic.to_param, id: first_post.to_param }
      expect(response).to redirect_to('/users/sign_in')
      expect(flash.alert).to eq('You must sign in first.')
    end

    it 'can be redirected to post on topic' do
      get :show, params: { forum_id: forum.to_param, topic_id: topic.to_param, id: first_post.to_param }
  ...
  context 'signed in' do
    ...
    context 'reply to topic' do
      ...
      context 'without permissions to read forum' do
        ...
        it 'cannot reply to topic' do
          post :create, params: { forum_id: forum.to_param, topic_id: topic.to_param, post: { 'text' => 'sneaky reply' } }
    ...
    context 'when attempting to destroy posts' do
      it 'can with permission' do
        delete :destroy, params: { forum_id: forum, topic_id: topic, id: topic.posts.first }
